...
class RegistroNotas
{
    ...
    public function addCabecalhoNotas()
    {
      //  $this->pdf->SetY(185);
        ...
        $this->pdf->Cell(375, 14, 'NOME',  1, 0, 'C', 0);
    ...
    $estudantedp = "- (DP)";
       ...
       // $this->pdf->SetFillColor(200,220,255);
        ...
        if(strlen($nomedisciplina[1])>0){
            $this->pdf->Cell(375, 14, $res->nome.' '.$estudantedp , 'LB', 0, 'R');
         }else{ $this->pdf->Cell(375, 14, ' '.$res->nome.' '.$estudantedp , 'LB', 0, 'R'); }
        ...
        if(strlen($res->AF)>0){
            $this->pdf->Cell(35,  14, number_format($res->AF, 1), 'LB', 0, 'C');
        } else $this->pdf->Cell(35,  14, '-', 'LB', 0, 'C');
