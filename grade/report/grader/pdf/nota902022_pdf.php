...
$context = context_course::instance($course->id);
  ...
  $error=null;
    ...
    include_once 'relatorioNotas902022.class.php';
...
//        $listAlunoNotas->A5 = $arrayA5[$aluno->id]->finalgrade;
  //      $listAlunoNotas->A6 = $arrayA6[$aluno->id]->finalgrade;
       ...
       // $somaNotas = ($listAlunoNotas->A1 + $listAlunoNotas->A2 + $listAlunoNotas->A3 + $listAlunoNotas->A4) /4;
        $somaNotas = ($listAlunoNotas->A1 + ($listAlunoNotas->A2*2) + $listAlunoNotas->A3 + ($listAlunoNotas->A4*2)+ $listAlunoNotas->A5+ ($listAlunoNotas->A6*2)) /9;
//$listAlunoNotas->AO = $somaNotas;
      //  if ((number_format($somaNotas, 2) != number_format($listAlunoNotas->AO,2)) AND $c == 0){ //round(1.95583, 2);
        if ((round($somaNotas, 1) != round($listAlunoNotas->AO,1)) AND $c == 0){ //round(1.95583, 2);
             $error .= '<div class="alert alert-danger" role="alert">O Cálculo do relatatório de notas: <b>'.number_format(round($somaNotas, 1), 2).'</b> é divergente do Cálculo da categoria do Moodle: <b>'.number_format(round($listAlunoNotas->AO,1), 2).'</b>, confira se o relatório de notas do Moodle está configurado o peso das atividades</b>;</div>';
             $c++;
         }
