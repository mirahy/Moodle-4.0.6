...
class config {
    ...
    public static function defaultvalues() {
        return array(
            ...
            'formats_allowed_default' => 'presentation,presentation_video',
    ...
    public static function get_options() {
        return array(
               ...
               'recordings_get_token' => self::get('recordings_get_token'),
               'recording_default' => self::get('recording_default'),
               'recording_editable' => self::get('recording_editable'),
               'formats_allowed' => self::get('formats_allowed'),
