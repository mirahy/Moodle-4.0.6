...
class format_menutopic_renderer extends format_section_renderer_base {
    ...
    protected function load_formatdata() {
        ...
        if (!is_object($formatdata)) {
            $formatdata = new stdClass();
             $format_data ='{"topics":[{"name":"Apresentação","subtopics":[],"topicnumber":"1","url":"","target":""},{"name":"Conteúdo Interativo","subtopics":[{"name":"Aula 1","subtopics":[],"topicnumber":"2","url":"","target":""},{"name":"Aula 2","subtopics":[],"topicnumber":"3","url":"","target":""},{"name":"Aula 3","subtopics":[],"topicnumber":"4","url":"","target":""},{"name":"Aula 4","subtopics":[],"topicnumber":"5","url":"","target":""}],"topicnumber":"","url":"","target":"_self"},{"name":"Biblioteca","subtopics":[],"topicnumber":"6","url":"","target":""},{"name":"Avaliações Online","subtopics":[],"topicnumber":"7","url":"","target":""}]}';
        }

$treecode ='{"topics":[{"name":"Apresentação","subtopics":[],"topicnumber":"1","url":"","target":""},{"name":"Conteúdo Interativo","subtopics":[{"name":"Aula 1","subtopics":[],"topicnumber":"2","url":"","target":""},{"name":"Aula 2","subtopics":[],"topicnumber":"3","url":"","target":""},{"name":"Aula 3","subtopics":[],"topicnumber":"4","url":"","target":""},{"name":"Aula 4","subtopics":[],"topicnumber":"5","url":"","target":""}],"topicnumber":"","url":"","target":"_self"},{"name":"Biblioteca","subtopics":[],"topicnumber":"6","url":"","target":""},{"name":"Avaliações Online","subtopics":[],"topicnumber":"7","url":"","target":""}]}';
